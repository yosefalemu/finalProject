...
const ApplyInstructions = async () => {
  return (
    <div className="p-6 border h-full flex flex-col items-center gap-y-2">
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                <div className="flex flex-col gap-y-4 max-w-screen-xl">
                  <h1 className="text-customColor font-extralight text-xl">
                    Take clear photos and scans of each document and convert to
                    pdf file
                  </h1>
                  <div className="w-3/4 mx-auto flex flex-col gap-y-2">
                    <h1 className="text-xl font-thin">
              ...
              <AccordionContent>
                <div className="flex flex-col gap-y-4 max-w-screen-xl">
                  <h1 className="text-customColor font-extralight text-xl">
                    ...
                    submission method specified by the Ethiopian Federal Police.
                    Ensure that all documents are legible, up-to-date, and meet
                    the specified requirements. We appreciate your commitment to
                    becoming a registered Private Security Agent. If you
                    encounter any difficulties during the application process,
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-x-2 text-customColor">
                  ...
                  <ArrowRight className="" size={12} />
                  <h1 className="text-2xl">Application Outcome Notification</h1>
                </div>
              </AccordionTrigger>
              <AccordionContent>
                <div className="flex flex-col gap-y-4 max-w-screen-xl">
                  ...
                  <div className="flex flex-col gap-y-2">
                    <h1 className="text-xl font-thin">
                      ...
                      commitment to maintaining security standards, and we wish
                      you success in your role.
                    </h1>
                    <h1 className="text-xl font-thin">
                      <span className="font-normal mr-2">
                        {" "}
                      ...
                      identified issues, and feel free to reapply. We appreciate
                      your interest and encourage you to make the necessary
                      adjustments before submitting a new application.
                    </h1>
                  </div>
                </div>
              </AccordionContent>
